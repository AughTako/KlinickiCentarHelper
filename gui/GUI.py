...
class Ui_MainWindow(object):
    punoIme = jmbg = lbo = filijala = datumVazenjaZKpolje = ""
    ...
    def setupUi(self, MainWindow):
        ...
        self.JMBGLineEdit = QtWidgets.QLineEdit(self.OsnovniPodaci)
        self.JMBGLineEdit.setObjectName(u"JMBG")
        self.JMBGLineEdit.setGeometry(QtCore.QRect(410, 20, 113, 20))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_18.setText(_translate("MainWindow", u"JMBG", None))
    ...
    def takeArgs(self): 
        ...
        if(self.JMBG.text() != ""):
            ...
            print(self.datumVazenjaZKpolje + " Ime: " + self.punoIme + " Filijala: " + self.filijala + " JMBG:" + self.jmbg + " " + self.vidTerapije)
