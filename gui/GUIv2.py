...
# TODO godine zivota, nalazenje br godina u odnosu na JMBG
...
class Ui_MainWindow(object):
    ...
    def takeArgs(self): 
        ...
        self.klinickaAktivnost = self.kAktBolestiCBox.currentIndex()
        ...
        if(self.opDa.isChecked()):
            ...
            if(self.razlogCBox.isChecked()):
                data['razlog_operacije_Ostalo'] = self.razlogOp_Dialog_Real.opis_RazOperacije
        ...
        data['razlog_operacije'] = self.razloziOp
