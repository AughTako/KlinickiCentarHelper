...
class Ui_fistulaDialog(object):
    ...
    def setupUi(self, fistulaDialog):
        ...
        self.fistZatButton = QtWidgets.QPushButton(fistulaDialog)
        self.fistZatButton.setGeometry(QtCore.QRect(320, 270, 75, 23))
        self.fistZatButton.setObjectName(u"fistZatButton")


        self.retranslateUi(fistulaDialog)
        QtCore.QMetaObject.connectSlotsByName(fistulaDialog)
        self.fistOKButton.clicked.connect(self.takeText)
        self.fistZatButton.clicked.connect(fistulaDialog.close)
    ...
    def retranslateUi(self, fistulaDialog):
        ...
        self.fistZatButton.setText(QCoreApplication.translate("Dialog", u"Zatvori!", None))
    def takeText(self):
        self.fist_Drugo = self.fistDialogText.toPlainText()
        self.fistOKButton.setEnabled(False)
